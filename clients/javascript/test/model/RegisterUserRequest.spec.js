...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GamifiedTaskManagementApi.RegisterUserRequest();
  });
  ...
  describe('RegisterUserRequest', function() {
    it('should create an instance of RegisterUserRequest', function() {
      ...
      //var instance = new GamifiedTaskManagementApi.RegisterUserRequest();
      //expect(instance).to.be.a(GamifiedTaskManagementApi.RegisterUserRequest);
    });
