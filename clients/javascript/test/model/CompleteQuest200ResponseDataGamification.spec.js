...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GamifiedTaskManagementApi.CompleteQuest200ResponseDataGamification();
  });
  ...
  describe('CompleteQuest200ResponseDataGamification', function() {
    it('should create an instance of CompleteQuest200ResponseDataGamification', function() {
      // uncomment below and update the code to test CompleteQuest200ResponseDataGamification
      //var instance = new GamifiedTaskManagementApi.CompleteQuest200ResponseDataGamification();
      //expect(instance).to.be.a(GamifiedTaskManagementApi.CompleteQuest200ResponseDataGamification);
    });
