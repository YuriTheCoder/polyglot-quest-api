...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GamifiedTaskManagementApi.ApiLeaderboardGet200ResponseDataLeaderboardInner();
  });
  ...
  describe('ApiLeaderboardGet200ResponseDataLeaderboardInner', function() {
    it('should create an instance of ApiLeaderboardGet200ResponseDataLeaderboardInner', function() {
      // uncomment below and update the code to test ApiLeaderboardGet200ResponseDataLeaderboardInner
      //var instance = new GamifiedTaskManagementApi.ApiLeaderboardGet200ResponseDataLeaderboardInner();
      //expect(instance).to.be.a(GamifiedTaskManagementApi.ApiLeaderboardGet200ResponseDataLeaderboardInner);
    });
