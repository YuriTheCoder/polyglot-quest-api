...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GamifiedTaskManagementApi.ApiTasksStoryPost201ResponseDataQuestsInner();
  });
  ...
  describe('ApiTasksStoryPost201ResponseDataQuestsInner', function() {
    it('should create an instance of ApiTasksStoryPost201ResponseDataQuestsInner', function() {
      // uncomment below and update the code to test ApiTasksStoryPost201ResponseDataQuestsInner
      //var instance = new GamifiedTaskManagementApi.ApiTasksStoryPost201ResponseDataQuestsInner();
      //expect(instance).to.be.a(GamifiedTaskManagementApi.ApiTasksStoryPost201ResponseDataQuestsInner);
    });
