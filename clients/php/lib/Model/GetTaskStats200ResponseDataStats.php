...
/**
 * GetTaskStats200ResponseDataStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTaskStats200ResponseDataStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTaskStats_200_response_data_stats';
    ...
    protected static $setters = [
        ...
        'overdue' => 'setOverdue',
        'completed_this_month' => 'setCompletedThisMonth'
    ];
    ...
    protected static $getters = [
        ...
        'overdue' => 'getOverdue',
        'completed_this_month' => 'getCompletedThisMonth'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('completed_this_month', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets overdue
     *
     * @param int|null $overdue overdue
     *
     * @return self
     */
    ...
    /**
     * Gets completed_this_month
     *
     * @return int|null
     */
    public function getCompletedThisMonth()
    {
        return $this->container['completed_this_month'];
    }

    /**
     * Sets completed_this_month
     *
     * @param int|null $completed_this_month completed_this_month
     *
     * @return self
     */
    public function setCompletedThisMonth($completed_this_month)
    {
        if (is_null($completed_this_month)) {
            throw new \InvalidArgumentException('non-nullable completed_this_month cannot be null');
        }
        $this->container['completed_this_month'] = $completed_this_month;
