...
/**
 * ChangeUserPasswordRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ChangeUserPasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'changeUserPassword_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['new_password']) < 6)) {
            $invalidProperties[] = "invalid value for 'new_password', the character length must be bigger than or equal to 6.";
        }
    ...
    public function setNewPassword($new_password)
    {
        ...
        if ((mb_strlen($new_password) < 6)) {
            throw new \InvalidArgumentException('invalid length for $new_password when calling ChangeUserPasswordRequest., must be bigger than or equal to 6.');
        }
