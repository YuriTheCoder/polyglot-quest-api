...
/**
 * ShareMilestoneRequestData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShareMilestoneRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shareMilestone_request_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('streak', $data ?? [], null);
    ...
    */
     ...
     * Sets streak
     *
     * @param float|null $streak streak
     *
     * @return self
     */
    ...
    {
        if (is_null($streak)) {
            throw new \InvalidArgumentException('non-nullable streak cannot be null');
        }
