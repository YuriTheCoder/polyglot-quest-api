    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateTaskRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 3)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateTaskRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateTaskRequest., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($description) < 10)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateTaskRequest., must be bigger than or equal to 10.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if ((count($tags) > 10)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling CreateTaskRequest., number of items must be less than or equal to 10.');
        }
