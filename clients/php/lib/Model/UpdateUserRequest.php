    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateUserRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateUserRequest., must be bigger than or equal to 2.');
        }
