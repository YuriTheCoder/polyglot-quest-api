...
// checks if the GetGlobalStats200ResponseDataStories type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGlobalStats200ResponseDataStories{}

// GetGlobalStats200ResponseDataStories struct for GetGlobalStats200ResponseDataStories
type GetGlobalStats200ResponseDataStories struct {
...
func NewGetGlobalStats200ResponseDataStories() *GetGlobalStats200ResponseDataStories {
	this := GetGlobalStats200ResponseDataStories{}
	return &this
}
...
func (o GetGlobalStats200ResponseDataStories) MarshalJSON() ([]byte, error) {
...
func (o GetGlobalStats200ResponseDataStories) ToMap() (map[string]interface{}, error) {
...
type NullableGetGlobalStats200ResponseDataStories struct {
	value *GetGlobalStats200ResponseDataStories
	isSet bool
}

func (v NullableGetGlobalStats200ResponseDataStories) Get() *GetGlobalStats200ResponseDataStories {
	return v.value
}

func (v *NullableGetGlobalStats200ResponseDataStories) Set(val *GetGlobalStats200ResponseDataStories) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGlobalStats200ResponseDataStories) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGlobalStats200ResponseDataStories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGlobalStats200ResponseDataStories(val *GetGlobalStats200ResponseDataStories) *NullableGetGlobalStats200ResponseDataStories {
	return &NullableGetGlobalStats200ResponseDataStories{value: val, isSet: true}
}

func (v NullableGetGlobalStats200ResponseDataStories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGlobalStats200ResponseDataStories) UnmarshalJSON(src []byte) error {
	v.isSet = true
