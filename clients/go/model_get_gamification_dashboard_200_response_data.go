...
// checks if the GetGamificationDashboard200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGamificationDashboard200ResponseData{}

// GetGamificationDashboard200ResponseData struct for GetGamificationDashboard200ResponseData
type GetGamificationDashboard200ResponseData struct {
	User *GetGamificationDashboard200ResponseDataUser `json:"user,omitempty"`
	Stats *GetGamificationDashboard200ResponseDataStats `json:"stats,omitempty"`
...
func NewGetGamificationDashboard200ResponseData() *GetGamificationDashboard200ResponseData {
	this := GetGamificationDashboard200ResponseData{}
	return &this
}
...
func (o *GetGamificationDashboard200ResponseData) GetUser() GetGamificationDashboard200ResponseDataUser {
	if o == nil || IsNil(o.User) {
		var ret GetGamificationDashboard200ResponseDataUser
		return ret
	}
	return *o.User
}
...
// SetUser gets a reference to the given GetGamificationDashboard200ResponseDataUser and assigns it to the User field.
...
func (o *GetGamificationDashboard200ResponseData) GetStats() GetGamificationDashboard200ResponseDataStats {
	if o == nil || IsNil(o.Stats) {
		var ret GetGamificationDashboard200ResponseDataStats
		return ret
	}
	return *o.Stats
}
...
// SetStats gets a reference to the given GetGamificationDashboard200ResponseDataStats and assigns it to the Stats field.
...
func (o GetGamificationDashboard200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetGamificationDashboard200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGetGamificationDashboard200ResponseData struct {
	value *GetGamificationDashboard200ResponseData
	isSet bool
}

func (v NullableGetGamificationDashboard200ResponseData) Get() *GetGamificationDashboard200ResponseData {
	return v.value
}

func (v *NullableGetGamificationDashboard200ResponseData) Set(val *GetGamificationDashboard200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGamificationDashboard200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGamificationDashboard200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGamificationDashboard200ResponseData(val *GetGamificationDashboard200ResponseData) *NullableGetGamificationDashboard200ResponseData {
	return &NullableGetGamificationDashboard200ResponseData{value: val, isSet: true}
}

func (v NullableGetGamificationDashboard200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGamificationDashboard200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
