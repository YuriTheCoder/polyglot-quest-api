...
// checks if the ToggleUserStatus200ResponseDataUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ToggleUserStatus200ResponseDataUser{}

// ToggleUserStatus200ResponseDataUser struct for ToggleUserStatus200ResponseDataUser
type ToggleUserStatus200ResponseDataUser struct {
...
func NewToggleUserStatus200ResponseDataUser() *ToggleUserStatus200ResponseDataUser {
	this := ToggleUserStatus200ResponseDataUser{}
	return &this
}
...
func (o ToggleUserStatus200ResponseDataUser) MarshalJSON() ([]byte, error) {
...
func (o ToggleUserStatus200ResponseDataUser) ToMap() (map[string]interface{}, error) {
...
type NullableToggleUserStatus200ResponseDataUser struct {
	value *ToggleUserStatus200ResponseDataUser
	isSet bool
}

func (v NullableToggleUserStatus200ResponseDataUser) Get() *ToggleUserStatus200ResponseDataUser {
	return v.value
}

func (v *NullableToggleUserStatus200ResponseDataUser) Set(val *ToggleUserStatus200ResponseDataUser) {
	v.value = val
	v.isSet = true
}

func (v NullableToggleUserStatus200ResponseDataUser) IsSet() bool {
	return v.isSet
}

func (v *NullableToggleUserStatus200ResponseDataUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableToggleUserStatus200ResponseDataUser(val *ToggleUserStatus200ResponseDataUser) *NullableToggleUserStatus200ResponseDataUser {
	return &NullableToggleUserStatus200ResponseDataUser{value: val, isSet: true}
}

func (v NullableToggleUserStatus200ResponseDataUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableToggleUserStatus200ResponseDataUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
