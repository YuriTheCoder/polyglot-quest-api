...
// checks if the GetGamificationDashboard200ResponseDataStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGamificationDashboard200ResponseDataStats{}

// GetGamificationDashboard200ResponseDataStats struct for GetGamificationDashboard200ResponseDataStats
type GetGamificationDashboard200ResponseDataStats struct {
...
func NewGetGamificationDashboard200ResponseDataStats() *GetGamificationDashboard200ResponseDataStats {
	this := GetGamificationDashboard200ResponseDataStats{}
	return &this
}
...
func (o *GetGamificationDashboard200ResponseDataStats) SetLevel(v float32) {
	o.Level = &v
}
...
func (o *GetGamificationDashboard200ResponseDataStats) HasTasksCompleted() bool {
	if o != nil && !IsNil(o.TasksCompleted) {
		return true
	}
...
func (o *GetGamificationDashboard200ResponseDataStats) GetBadges() []string {
...
func (o GetGamificationDashboard200ResponseDataStats) MarshalJSON() ([]byte, error) {
...
func (o GetGamificationDashboard200ResponseDataStats) ToMap() (map[string]interface{}, error) {
...
type NullableGetGamificationDashboard200ResponseDataStats struct {
	value *GetGamificationDashboard200ResponseDataStats
	isSet bool
}

func (v NullableGetGamificationDashboard200ResponseDataStats) Get() *GetGamificationDashboard200ResponseDataStats {
	return v.value
}

func (v *NullableGetGamificationDashboard200ResponseDataStats) Set(val *GetGamificationDashboard200ResponseDataStats) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGamificationDashboard200ResponseDataStats) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGamificationDashboard200ResponseDataStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGamificationDashboard200ResponseDataStats(val *GetGamificationDashboard200ResponseDataStats) *NullableGetGamificationDashboard200ResponseDataStats {
	return &NullableGetGamificationDashboard200ResponseDataStats{value: val, isSet: true}
}

func (v NullableGetGamificationDashboard200ResponseDataStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGamificationDashboard200ResponseDataStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
