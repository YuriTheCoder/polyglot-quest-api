...
// checks if the ApiTasksStatusStatusGet200ResponseDataPagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTasksStatusStatusGet200ResponseDataPagination{}

// ApiTasksStatusStatusGet200ResponseDataPagination struct for ApiTasksStatusStatusGet200ResponseDataPagination
type ApiTasksStatusStatusGet200ResponseDataPagination struct {
...
func NewApiTasksStatusStatusGet200ResponseDataPagination() *ApiTasksStatusStatusGet200ResponseDataPagination {
	this := ApiTasksStatusStatusGet200ResponseDataPagination{}
	return &this
}
...
func (o ApiTasksStatusStatusGet200ResponseDataPagination) MarshalJSON() ([]byte, error) {
...
func (o ApiTasksStatusStatusGet200ResponseDataPagination) ToMap() (map[string]interface{}, error) {
...
type NullableApiTasksStatusStatusGet200ResponseDataPagination struct {
	value *ApiTasksStatusStatusGet200ResponseDataPagination
	isSet bool
}

func (v NullableApiTasksStatusStatusGet200ResponseDataPagination) Get() *ApiTasksStatusStatusGet200ResponseDataPagination {
	return v.value
}

func (v *NullableApiTasksStatusStatusGet200ResponseDataPagination) Set(val *ApiTasksStatusStatusGet200ResponseDataPagination) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTasksStatusStatusGet200ResponseDataPagination) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTasksStatusStatusGet200ResponseDataPagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTasksStatusStatusGet200ResponseDataPagination(val *ApiTasksStatusStatusGet200ResponseDataPagination) *NullableApiTasksStatusStatusGet200ResponseDataPagination {
	return &NullableApiTasksStatusStatusGet200ResponseDataPagination{value: val, isSet: true}
}

func (v NullableApiTasksStatusStatusGet200ResponseDataPagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTasksStatusStatusGet200ResponseDataPagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
