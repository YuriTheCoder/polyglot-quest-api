...
// checks if the ListTasksByStatus200ResponseDataPagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasksByStatus200ResponseDataPagination{}

// ListTasksByStatus200ResponseDataPagination struct for ListTasksByStatus200ResponseDataPagination
type ListTasksByStatus200ResponseDataPagination struct {
...
func NewListTasksByStatus200ResponseDataPagination() *ListTasksByStatus200ResponseDataPagination {
	this := ListTasksByStatus200ResponseDataPagination{}
	return &this
}
...
func (o ListTasksByStatus200ResponseDataPagination) MarshalJSON() ([]byte, error) {
...
func (o ListTasksByStatus200ResponseDataPagination) ToMap() (map[string]interface{}, error) {
...
type NullableListTasksByStatus200ResponseDataPagination struct {
	value *ListTasksByStatus200ResponseDataPagination
	isSet bool
}

func (v NullableListTasksByStatus200ResponseDataPagination) Get() *ListTasksByStatus200ResponseDataPagination {
	return v.value
}

func (v *NullableListTasksByStatus200ResponseDataPagination) Set(val *ListTasksByStatus200ResponseDataPagination) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasksByStatus200ResponseDataPagination) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasksByStatus200ResponseDataPagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasksByStatus200ResponseDataPagination(val *ListTasksByStatus200ResponseDataPagination) *NullableListTasksByStatus200ResponseDataPagination {
	return &NullableListTasksByStatus200ResponseDataPagination{value: val, isSet: true}
}

func (v NullableListTasksByStatus200ResponseDataPagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasksByStatus200ResponseDataPagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
