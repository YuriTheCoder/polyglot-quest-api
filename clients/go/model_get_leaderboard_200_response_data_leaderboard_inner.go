...
// checks if the GetLeaderboard200ResponseDataLeaderboardInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLeaderboard200ResponseDataLeaderboardInner{}

// GetLeaderboard200ResponseDataLeaderboardInner struct for GetLeaderboard200ResponseDataLeaderboardInner
type GetLeaderboard200ResponseDataLeaderboardInner struct {
...
func NewGetLeaderboard200ResponseDataLeaderboardInner() *GetLeaderboard200ResponseDataLeaderboardInner {
	this := GetLeaderboard200ResponseDataLeaderboardInner{}
	return &this
}
...
func (o *GetLeaderboard200ResponseDataLeaderboardInner) SetRank(v float32) {
	o.Rank = &v
}
...
func (o GetLeaderboard200ResponseDataLeaderboardInner) MarshalJSON() ([]byte, error) {
...
func (o GetLeaderboard200ResponseDataLeaderboardInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetLeaderboard200ResponseDataLeaderboardInner struct {
	value *GetLeaderboard200ResponseDataLeaderboardInner
	isSet bool
}

func (v NullableGetLeaderboard200ResponseDataLeaderboardInner) Get() *GetLeaderboard200ResponseDataLeaderboardInner {
	return v.value
}

func (v *NullableGetLeaderboard200ResponseDataLeaderboardInner) Set(val *GetLeaderboard200ResponseDataLeaderboardInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLeaderboard200ResponseDataLeaderboardInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLeaderboard200ResponseDataLeaderboardInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLeaderboard200ResponseDataLeaderboardInner(val *GetLeaderboard200ResponseDataLeaderboardInner) *NullableGetLeaderboard200ResponseDataLeaderboardInner {
	return &NullableGetLeaderboard200ResponseDataLeaderboardInner{value: val, isSet: true}
}

func (v NullableGetLeaderboard200ResponseDataLeaderboardInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLeaderboard200ResponseDataLeaderboardInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
