...
// checks if the ApiGamificationGlobalStatsGet200ResponseDataGamification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiGamificationGlobalStatsGet200ResponseDataGamification{}

// ApiGamificationGlobalStatsGet200ResponseDataGamification struct for ApiGamificationGlobalStatsGet200ResponseDataGamification
type ApiGamificationGlobalStatsGet200ResponseDataGamification struct {
...
func NewApiGamificationGlobalStatsGet200ResponseDataGamification() *ApiGamificationGlobalStatsGet200ResponseDataGamification {
	this := ApiGamificationGlobalStatsGet200ResponseDataGamification{}
	return &this
}
...
func (o ApiGamificationGlobalStatsGet200ResponseDataGamification) MarshalJSON() ([]byte, error) {
...
func (o ApiGamificationGlobalStatsGet200ResponseDataGamification) ToMap() (map[string]interface{}, error) {
...
type NullableApiGamificationGlobalStatsGet200ResponseDataGamification struct {
	value *ApiGamificationGlobalStatsGet200ResponseDataGamification
	isSet bool
}

func (v NullableApiGamificationGlobalStatsGet200ResponseDataGamification) Get() *ApiGamificationGlobalStatsGet200ResponseDataGamification {
	return v.value
}

func (v *NullableApiGamificationGlobalStatsGet200ResponseDataGamification) Set(val *ApiGamificationGlobalStatsGet200ResponseDataGamification) {
	v.value = val
	v.isSet = true
}

func (v NullableApiGamificationGlobalStatsGet200ResponseDataGamification) IsSet() bool {
	return v.isSet
}

func (v *NullableApiGamificationGlobalStatsGet200ResponseDataGamification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiGamificationGlobalStatsGet200ResponseDataGamification(val *ApiGamificationGlobalStatsGet200ResponseDataGamification) *NullableApiGamificationGlobalStatsGet200ResponseDataGamification {
	return &NullableApiGamificationGlobalStatsGet200ResponseDataGamification{value: val, isSet: true}
}

func (v NullableApiGamificationGlobalStatsGet200ResponseDataGamification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiGamificationGlobalStatsGet200ResponseDataGamification) UnmarshalJSON(src []byte) error {
	v.isSet = true
