...
// checks if the ApiTasksGet200ResponseDataPagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTasksGet200ResponseDataPagination{}

// ApiTasksGet200ResponseDataPagination struct for ApiTasksGet200ResponseDataPagination
type ApiTasksGet200ResponseDataPagination struct {
...
func NewApiTasksGet200ResponseDataPagination() *ApiTasksGet200ResponseDataPagination {
	this := ApiTasksGet200ResponseDataPagination{}
	return &this
}
...
func (o ApiTasksGet200ResponseDataPagination) MarshalJSON() ([]byte, error) {
...
func (o ApiTasksGet200ResponseDataPagination) ToMap() (map[string]interface{}, error) {
...
type NullableApiTasksGet200ResponseDataPagination struct {
	value *ApiTasksGet200ResponseDataPagination
	isSet bool
}

func (v NullableApiTasksGet200ResponseDataPagination) Get() *ApiTasksGet200ResponseDataPagination {
	return v.value
}

func (v *NullableApiTasksGet200ResponseDataPagination) Set(val *ApiTasksGet200ResponseDataPagination) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTasksGet200ResponseDataPagination) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTasksGet200ResponseDataPagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTasksGet200ResponseDataPagination(val *ApiTasksGet200ResponseDataPagination) *NullableApiTasksGet200ResponseDataPagination {
	return &NullableApiTasksGet200ResponseDataPagination{value: val, isSet: true}
}

func (v NullableApiTasksGet200ResponseDataPagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTasksGet200ResponseDataPagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
