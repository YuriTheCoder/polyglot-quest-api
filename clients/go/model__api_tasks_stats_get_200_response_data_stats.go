...
// checks if the ApiTasksStatsGet200ResponseDataStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTasksStatsGet200ResponseDataStats{}

// ApiTasksStatsGet200ResponseDataStats struct for ApiTasksStatsGet200ResponseDataStats
type ApiTasksStatsGet200ResponseDataStats struct {
...
func NewApiTasksStatsGet200ResponseDataStats() *ApiTasksStatsGet200ResponseDataStats {
	this := ApiTasksStatsGet200ResponseDataStats{}
	return &this
}
...
func (o ApiTasksStatsGet200ResponseDataStats) MarshalJSON() ([]byte, error) {
...
func (o ApiTasksStatsGet200ResponseDataStats) ToMap() (map[string]interface{}, error) {
...
type NullableApiTasksStatsGet200ResponseDataStats struct {
	value *ApiTasksStatsGet200ResponseDataStats
	isSet bool
}

func (v NullableApiTasksStatsGet200ResponseDataStats) Get() *ApiTasksStatsGet200ResponseDataStats {
	return v.value
}

func (v *NullableApiTasksStatsGet200ResponseDataStats) Set(val *ApiTasksStatsGet200ResponseDataStats) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTasksStatsGet200ResponseDataStats) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTasksStatsGet200ResponseDataStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTasksStatsGet200ResponseDataStats(val *ApiTasksStatsGet200ResponseDataStats) *NullableApiTasksStatsGet200ResponseDataStats {
	return &NullableApiTasksStatsGet200ResponseDataStats{value: val, isSet: true}
}

func (v NullableApiTasksStatsGet200ResponseDataStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTasksStatsGet200ResponseDataStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
