...
// checks if the CompleteTask200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompleteTask200Response{}

// CompleteTask200Response struct for CompleteTask200Response
type CompleteTask200Response struct {
...
func (o CompleteTask200Response) MarshalJSON() ([]byte, error) {
...
func (o CompleteTask200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCompleteTask200Response struct {
	value *CompleteTask200Response
	isSet bool
}

func (v NullableCompleteTask200Response) Get() *CompleteTask200Response {
	return v.value
}

func (v *NullableCompleteTask200Response) Set(val *CompleteTask200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCompleteTask200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCompleteTask200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompleteTask200Response(val *CompleteTask200Response) *NullableCompleteTask200Response {
	return &NullableCompleteTask200Response{value: val, isSet: true}
}

func (v NullableCompleteTask200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompleteTask200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
