...
class TestApiGamificationGlobalStatsGet200Response(unittest.TestCase):
    """ApiGamificationGlobalStatsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiGamificationGlobalStatsGet200Response:
        """Test ApiGamificationGlobalStatsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiGamificationGlobalStatsGet200Response`
        """
        model = ApiGamificationGlobalStatsGet200Response()
        if include_optional:
            return ApiGamificationGlobalStatsGet200Response(
                success = True,
                data = openapi_client.models._api_gamification_global_stats_get_200_response_data._api_gamification_global_stats_get_200_response_data(
    ...
    def testApiGamificationGlobalStatsGet200Response(self):
        """Test ApiGamificationGlobalStatsGet200Response"""
