...
class TestGetGlobalStats200ResponseData(unittest.TestCase):
    """GetGlobalStats200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlobalStats200ResponseData:
        """Test GetGlobalStats200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlobalStats200ResponseData`
        """
        model = GetGlobalStats200ResponseData()
        if include_optional:
            return GetGlobalStats200ResponseData(
    ...
    def testGetGlobalStats200ResponseData(self):
        """Test GetGlobalStats200ResponseData"""
