...
class ApiTasksStoryPostRequest(BaseModel):
    """
    ApiTasksStoryPostRequest
    """ # noqa: E501
    task_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=10)] = Field(alias="taskIds")
    user_preferences: Optional[ApiTasksStoryPostRequestUserPreferences] = Field(default=None, alias="userPreferences")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userPreferences": ApiTasksStoryPostRequestUserPreferences.from_dict(obj["userPreferences"]) if obj.get("userPreferences") is not None else None
        })
        return _obj
