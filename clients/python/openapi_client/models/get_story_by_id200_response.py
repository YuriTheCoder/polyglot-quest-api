...
class GetStoryById200Response(BaseModel):
    """
    GetStoryById200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[GetStoryById200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetStoryById200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
