...
class ApiGamificationBadgesGet200Response(BaseModel):
    """
    ApiGamificationBadgesGet200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[ApiGamificationBadgesGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiGamificationBadgesGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
