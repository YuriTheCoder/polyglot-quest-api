...
class ToggleUserStatus200ResponseData(BaseModel):
    """
    ToggleUserStatus200ResponseData
    """ # noqa: E501
    user: Optional[ToggleUserStatus200ResponseDataUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": ToggleUserStatus200ResponseDataUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
