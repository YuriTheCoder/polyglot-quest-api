...
class ListTasksByStatus200ResponseData(BaseModel):
    """
    ListTasksByStatus200ResponseData
    """ # noqa: E501
    tasks: Optional[List[Task]] = None
    pagination: Optional[ListTasksByStatus200ResponseDataPagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ListTasksByStatus200ResponseDataPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
