...
class ApiUsersStatsGet200ResponseDataTasks(BaseModel):
    """
    ...
    in_progress: Optional[StrictInt] = Field(default=None, alias="inProgress")
    overdue: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total", "completed", "pending", "inProgress", "overdue"]
