...
class ApiTasksGet200ResponseData(BaseModel):
    """
    ApiTasksGet200ResponseData
    """ # noqa: E501
    tasks: Optional[List[Task]] = None
    pagination: Optional[ApiTasksGet200ResponseDataPagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ApiTasksGet200ResponseDataPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
