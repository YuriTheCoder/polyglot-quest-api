...
class ApiTasksStatsGet200ResponseDataStats(BaseModel):
    """
    ...
    completed_this_month: Optional[StrictInt] = Field(default=None, alias="completedThisMonth")
    __properties: ClassVar[List[str]] = ["total", "pending", "in_progress", "completed", "overdue", "completedThisMonth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completedThisMonth": obj.get("completedThisMonth")
        })
        return _obj
