...
class GetBadges200Response(BaseModel):
    """
    GetBadges200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[GetBadges200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetBadges200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
