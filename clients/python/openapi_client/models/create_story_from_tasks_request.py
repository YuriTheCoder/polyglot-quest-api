...
class CreateStoryFromTasksRequest(BaseModel):
    """
    CreateStoryFromTasksRequest
    """ # noqa: E501
    task_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=10)] = Field(alias="taskIds")
    user_preferences: Optional[CreateStoryFromTasksRequestUserPreferences] = Field(default=None, alias="userPreferences")
    __properties: ClassVar[List[str]] = ["taskIds", "userPreferences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userPreferences": CreateStoryFromTasksRequestUserPreferences.from_dict(obj["userPreferences"]) if obj.get("userPreferences") is not None else None
        })
        return _obj
