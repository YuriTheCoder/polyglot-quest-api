...
class ApiGamificationSharePostRequestData(BaseModel):
    """
    ApiGamificationSharePostRequestData
    """ # noqa: E501
    level: Optional[Union[StrictFloat, StrictInt]] = None
    badge: Optional[Dict[str, Any]] = None
    streak: Optional[Union[StrictFloat, StrictInt]] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["level", "badge", "streak", "message"]
