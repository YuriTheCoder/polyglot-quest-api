...
class ListTasks200ResponseData(BaseModel):
    """
    ListTasks200ResponseData
    """ # noqa: E501
    tasks: Optional[List[Task]] = None
    pagination: Optional[ListTasks200ResponseDataPagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ListTasks200ResponseDataPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
