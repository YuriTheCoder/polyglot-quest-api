...
class ApiUsersStatsGet200ResponseDataMostActiveUsersInner(BaseModel):
    """
    ...
    task_count: Optional[StrictInt] = Field(default=None, alias="taskCount")
    __properties: ClassVar[List[str]] = ["userId", "name", "email", "taskCount"]
