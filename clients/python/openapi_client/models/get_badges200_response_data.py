...
class GetBadges200ResponseData(BaseModel):
    """
    GetBadges200ResponseData
    """ # noqa: E501
    earned: Optional[List[GetBadges200ResponseDataEarnedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "earned": [GetBadges200ResponseDataEarnedInner.from_dict(_item) for _item in obj["earned"]] if obj.get("earned") is not None else None,
