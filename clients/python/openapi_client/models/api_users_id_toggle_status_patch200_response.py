...
class ApiUsersIdToggleStatusPatch200Response(BaseModel):
    """
    ApiUsersIdToggleStatusPatch200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    data: Optional[ApiUsersIdToggleStatusPatch200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiUsersIdToggleStatusPatch200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
