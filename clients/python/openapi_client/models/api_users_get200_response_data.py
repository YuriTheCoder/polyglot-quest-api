...
class ApiUsersGet200ResponseData(BaseModel):
    """
    ApiUsersGet200ResponseData
    """ # noqa: E501
    users: Optional[List[User]] = None
    pagination: Optional[ApiUsersGet200ResponseDataPagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ApiUsersGet200ResponseDataPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
