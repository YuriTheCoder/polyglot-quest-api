...
public class ApiGamificationPreferencesPutRequest {
  /**
  ...
  public ApiGamificationPreferencesPutRequest() {
  }

  public ApiGamificationPreferencesPutRequest propertyClass(@javax.annotation.Nullable PropertyClassEnum propertyClass) {
  ...
  public ApiGamificationPreferencesPutRequest theme(@javax.annotation.Nullable ThemeEnum theme) {
    this.theme = theme;
    return this;
  }
  ...
  public ApiGamificationPreferencesPutRequest autoShare(@javax.annotation.Nullable Boolean autoShare) {
  ...
  public ApiGamificationPreferencesPutRequest shareOnLevelUp(@javax.annotation.Nullable Boolean shareOnLevelUp) {
  ...
  public ApiGamificationPreferencesPutRequest shareOnBadge(@javax.annotation.Nullable Boolean shareOnBadge) {
  ...
  public boolean equals(Object o) {
    ...
    ApiGamificationPreferencesPutRequest apiGamificationPreferencesPutRequest = (ApiGamificationPreferencesPutRequest) o;
    return Objects.equals(this.propertyClass, apiGamificationPreferencesPutRequest.propertyClass) &&
        Objects.equals(this.theme, apiGamificationPreferencesPutRequest.theme) &&
        Objects.equals(this.autoShare, apiGamificationPreferencesPutRequest.autoShare) &&
        Objects.equals(this.shareOnLevelUp, apiGamificationPreferencesPutRequest.shareOnLevelUp) &&
        Objects.equals(this.shareOnBadge, apiGamificationPreferencesPutRequest.shareOnBadge);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiGamificationPreferencesPutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiGamificationPreferencesPutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiGamificationPreferencesPutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiGamificationPreferencesPutRequest is not found in the empty JSON string", ApiGamificationPreferencesPutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiGamificationPreferencesPutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiGamificationPreferencesPutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiGamificationPreferencesPutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiGamificationPreferencesPutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiGamificationPreferencesPutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiGamificationPreferencesPutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiGamificationPreferencesPutRequest>() {
           @Override
           public void write(JsonWriter out, ApiGamificationPreferencesPutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiGamificationPreferencesPutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiGamificationPreferencesPutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiGamificationPreferencesPutRequest
   * @throws IOException if the JSON string is invalid with respect to ApiGamificationPreferencesPutRequest
   */
  public static ApiGamificationPreferencesPutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiGamificationPreferencesPutRequest.class);
  }

  /**
   * Convert an instance of ApiGamificationPreferencesPutRequest to an JSON string
   *
   * @return JSON string
   */
