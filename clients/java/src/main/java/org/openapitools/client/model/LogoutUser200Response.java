...
public class LogoutUser200Response {
  ...
  public LogoutUser200Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public LogoutUser200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, logoutUser200Response.success) &&
        Objects.equals(this.message, logoutUser200Response.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogoutUser200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogoutUser200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogoutUser200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogoutUser200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
